    ...
    <div style={{ fontFamily: theme.font.base, direction: 'rtl', backgroundColor: '#f8fafc', minHeight: '100vh' }}>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
          <a href="/login" style={{ color: '#64748b', fontSize: '13px', fontWeight: 600, textDecoration: 'none' }}>
            تسجيل الدخول
          </a>
      ...
      <section style={{
        ...
        <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
          ...
          <a
            href="https://www.facebook.com/profile.php?id=61576048735334"
            target="_blank"
      ...
      <section style={{ padding: '56px 20px', maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          {features.map((feat, i) => (
            <div key={i} style={{ 
              padding: '30px 24px', 
              borderLeft: i % 2 === 0 && i < 14 ? '1px solid #e2e8f0' : 'none', 
      ...
      <section id="register-form" style={{ padding: '40px 20px 60px', maxWidth: '700px', margin: '0 auto' }}>
        <div style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {/* الباقة المختارة */}
            <div style={{
              background: form.plan === 'free' ? '#d1fae5' : '#dbeafe',
              padding: '10px 16px',
              borderRadius: '10px',
              textAlign: 'center',
              fontSize: '14px',
              fontWeight: 700,
              color: form.plan === 'free' ? '#065f46' : '#1e40af',
            }}>
              {form.plan === 'free' 
            ...
            {/* رفع الملف (للباقة المدفوعة) */}
            {form.plan === 'paid' && (
              <div>
                <label style={{ display: 'block', fontSize: '12px', fontWeight: 700, color: '#64748b', marginBottom: '6px' }}>
                  وصل الدفع * 
                  <span style={{ fontSize: '11px', color: '#ef4444', marginRight: '6px' }}>(مطلوب)</span>
                </label>
                <div style={{
                  border: `2px dashed ${fileError ? '#ef4444' : file ? '#10b981' : '#cbd5e1'}`,
                  borderRadius: '10px',
                  padding: '20px',
                  textAlign: 'center',
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', marginTop: '4px' }}>
              <input
                ...
                style={{ marginTop: '4px', width: '18px', height: '18px', accentColor: '#2563eb' }}
                required
              />
            ...
            <button
              ...
              style={{
                ...
                background: loading ? '#94a3b8' : (form.plan === 'free' ? '#059669' : '#2563eb'),
                color: '#fff',
                transition: 'all 0.25s',
                display: 'inline-flex',
                alignItems: 'center',
      ...
      <footer style={{
        ...
        <span style={{ fontFamily: 'Amiri, serif', fontSize: '20px', fontWeight: 700 }}>
          إعلم<span style={{ color: '#2563eb' }}>.</span>
        </span>
